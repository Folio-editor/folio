...
- **1크레딧 = 0.8원** (10000원 = 13000 credits, 2026-05-08 개정)
- **기능 사용 시 차감 = ROUND(API 원가 × 1.3 ÷ 0.8)** — 30% 마진 자동 확보
...
| 2026-05-08 | 1크레딧 = 0.8원으로 세분화 | 0.2 크레딧 상당 호출이 ROUND 후 0 으로 떨어져 무료 처리되던 문제 해소 (10배 정밀도) |
