...
const EVENT_PARAMS: Record<AnalyticsEventName, Set<string>> = {
  ...
  account_withdrawn: new Set(['platform']),
  account_restored: new Set(['platform']),
  account_restore_failed: new Set(['reason_code']),
  ...
  ai_chat_opened: new Set(['entry_source']),
  ai_chat_thread_created: new Set(['scenario']),
  ai_chat_thread_create_failed: new Set(['reason_code']),
  ai_chat_message_sent: new Set(['message_char_count_bucket']),
  ai_chat_message_succeeded: new Set([
    'duration_bucket',
    'suggestion_count_bucket',
    'status',
  ]),
  ai_chat_message_failed: new Set(['reason_code']),
  ai_chat_message_aborted: new Set(['duration_bucket']),
  ...
  ai_spellcheck_failed: new Set(['doc_type', 'reason_code', 'mode']),
