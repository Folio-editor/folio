...
export const COLOR_THEMES: ColorThemeDef[] = [
  ...
  },
  {
    ...
    previewDark: SHARED_DARK_SURFACE,
    previewPrimaryLight: 'oklch(0.42 0.10 155)',
    previewPrimaryDark: 'oklch(0.72 0.10 155)',
  },
  {
    id: 'ocean',
    label: '오션',
    ...
    previewDark: SHARED_DARK_SURFACE,
    previewPrimaryLight: 'oklch(0.45 0.14 245)',
    previewPrimaryDark: 'oklch(0.72 0.12 245)',
  },
  {
    id: 'rose',
    label: '로즈',
    ...
    previewDark: SHARED_DARK_SURFACE,
    previewPrimaryLight: 'oklch(0.55 0.15 355)',
    previewPrimaryDark: 'oklch(0.75 0.12 355)',
  },
  {
    id: 'lavender',
    label: '라벤더',
    ...
    previewDark: SHARED_DARK_SURFACE,
    previewPrimaryLight: 'oklch(0.50 0.14 300)',
    previewPrimaryDark: 'oklch(0.75 0.12 300)',
  },
];
