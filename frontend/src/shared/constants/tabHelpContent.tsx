      ...
      },
      {
        ...
        body: (
          <ul className="list-disc space-y-1 pl-4">
            <li>
              <H>한 줄 소개 / 외형 / 성격</H> — 캐릭터 생성 시 자동 추가, 삭제 불가
            </li>
            <li>
              <H>사용자 노트</H> — 자유롭게 추가·삭제. 동기·관계·비밀 등을 따로 정리
            </li>
          </ul>
        ),
      },
    ...
    steps: [
      {
        ...
        body: (
          <p>
            새 작품에는 <H>시대/배경 · 공간/지리 · 세력/조직 · 규칙/법칙 · 역사/연표</H> 5개의
            기본 템플릿이 자동 생성돼요. 필요한 만큼 자유롭게 추가·삭제할 수 있습니다.
          </p>
        ),
      },
      {
