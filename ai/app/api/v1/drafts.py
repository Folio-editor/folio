...
SYSTEM_PROMPT = (
    ...
    "- 의뢰 번호, 날짜, 고유 식별자는 이전 화나 유사 청크의 값을 그대로 복사하지 마세요.\n"
    "- 작가가 지시하지 않은 서사적 무게의 설정(이혼, 질병, 사고, 사망 등)을 "
    "임의로 추가하지 마세요. 의뢰인이나 조연의 배경은 스토리라인에 명시된 범위에서만 다루세요.\n\n"
    ...
    "차가운 캐릭터는 차갑게, 절제된 캐릭터는 절제되게 유지하세요.\n"
    "- 인물이 개인적 약속, 미래 예측, 감정 표현을 하지 않는 성격으로 설정됐다면, "
    "그 규칙을 벗어나지 마세요.\n\n"
