 ...
 *   <li>차감 = ROUND(API 원가 × 1.3 ÷ 0.8)  — 2026-05-11 정상 서비스 가격 (1.1 → 1.3 복귀)</li>
 *   <li>USD → KRW = 1,450</li>
 * </ul>
 *
 ...
 *
 * <p>마진 이력: 1.3 (초기) → 1.1 (2026-05-09 알파 인하) → 1.3 (2026-05-11 정상 가격 복귀).
 * AI 측 budget.py MARGIN_RATIO 와 항상 동기화 필수.
 */
@Component
